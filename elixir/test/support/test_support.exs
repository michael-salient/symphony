defmodule SymphonyElixir.TestSupport do
  ...
  defp workflow_content(overrides) do
    ...
    workspace_repository_url = Keyword.get(config, :workspace_repository_url)
    workspace_repository_aliases = Keyword.get(config, :workspace_repository_aliases)
    ...
    sections =
      [
        ...
        "  repository_url: #{yaml_value(workspace_repository_url)}",
        "  repository_aliases: #{yaml_value(workspace_repository_aliases)}",
